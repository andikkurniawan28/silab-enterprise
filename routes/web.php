...
use App\Http\Controllers\ParameterOptionController;
...
// Route::get('/parameter_option', [ParameterOptionController::class, 'index'])->name('parameter_option.index')->middleware(['auth', 'check.permission']);
// Route::get('/parameter_option/{parameter_id}/adjust', [ParameterOptionController::class, 'adjust'])->name('parameter_option.adjust')->middleware(['auth', 'check.permission']);
// Route::put('/parameter_option/{parameter_id}', [ParameterOptionController::class, 'update'])->name('parameter_option.update')->middleware(['auth', 'check.permission']);
