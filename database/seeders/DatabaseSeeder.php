...
class DatabaseSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $features = [
            ...
            ['name' => ucfirst(str_replace('_', ' ', 'list_of_permission')), 'route' => 'permission.index'],
            ['name' => ucfirst(str_replace('_', ' ', 'adjust_permission')), 'route' => 'permission.adjust'],
            ['name' => ucfirst(str_replace('_', ' ', 'update_permission')), 'route' => 'permission.update'],
