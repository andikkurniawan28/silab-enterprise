...
class DatabaseSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $features = [
            ...
            ['name' => ucfirst(str_replace('_', ' ', 'list_of_company')), 'route' => 'company.index'],
            ['name' => ucfirst(str_replace('_', ' ', 'create_company')), 'route' => 'company.create'],
            ['name' => ucfirst(str_replace('_', ' ', 'save_company')), 'route' => 'company.store'],
            ['name' => ucfirst(str_replace('_', ' ', 'edit_company')), 'route' => 'company.edit'],
            ['name' => ucfirst(str_replace('_', ' ', 'update_company')), 'route' => 'company.update'],
            ['name' => ucfirst(str_replace('_', ' ', 'delete_company')), 'route' => 'company.destroy'],
