                    ...
                    <div class="card-body">
                        <form action="{{ route("parameter.update", $parameter->id) }}" method="POST">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="number" step="any" class="form-control" id="min" name="min" value="{{ $parameter->min }}" required>
                                </div>
                            </div>
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="number" step="any" class="form-control" id="max" name="max" value="{{ $parameter->max }}" required>
                                </div>
                            </div>
