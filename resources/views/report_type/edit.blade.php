...
@section('title')
    {{ ucwords(str_replace('_', ' ', 'edit_report_type')) }}
@endsection
        ...
        <div class="row">
            <div class="col-xxl">
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <form action="{{ route("report_type.update", $report_type->id) }}" method="POST">
                            @csrf @method("PUT")
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="name" name="name" value="{{ $report_type->name }}" required autofocus>
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10 material-section">
                                    ...
                                    @foreach ($materials as $material)
                                        @php
                                            $isChecked = $report_type_contents->contains('material_id', $material->id);
                                        @endphp
                                        <div class="form-check">
                                            <input class="form-check-input material-checkbox" type="checkbox"
                                                name="material_ids[]" value="{{ $material->id }}"
                                                id="material_{{ $material->id }}" {{ $isChecked ? 'checked' : '' }}>
